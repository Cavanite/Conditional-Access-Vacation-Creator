...
function Initialize-Named-Location {
    ...
    [PSCustomObject]@{Name = "Cote d'Ivoire"; Code = "CI"},
    [PSCustomObject]@{Name = "Croatia"; Code = "HR"},
    [PSCustomObject]@{Name = "Cuba"; Code = "CU"},
    [PSCustomObject]@{Name = "Curacao"; Code = "CW"},
    ...
    [PSCustomObject]@{Name = "Sao Tome and Principe"; Code = "ST"},
